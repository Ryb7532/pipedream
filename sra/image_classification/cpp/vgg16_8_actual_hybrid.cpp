...
/*
  string cmd = "nvprof --profile-child-processes -o vgg16_8_actual_hybrid_";
  cmd += stm0.str();
...
*/
  ...
  cmd += " --node_rank ";
  cmd += stm0.str();
  cmd += " --nproc_per_node 4 main_with_runtime.py -s --distributed_backend gloo -m models.vgg16.gpus=8_actual --epochs 6 -b 16 --config_path models/vgg16/gpus=8_actual/hybrid_conf.json  --num_ranks_in_server 4 --master_addr ";
  cmd += (string)argv[1];
