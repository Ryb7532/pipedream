...
/*
  string cmd = "nvprof --profile-child-processes -o alexnet_1_dp_";
  cmd += stm0.str();
...
*/
  ...
  cmd += " --node_rank ";
  cmd += stm0.str();
  cmd += " --nproc_per_node 1 main_with_runtime.py -s --distributed_backend nccl -m models.alexnet.gpus=1 --epochs 6 -b 256 --config_path models/alexnet/gpus=1/dp_conf.json --no_input_pipelining --num_ranks_in_server 1 --master_addr ";
  cmd += (string)argv[1];
