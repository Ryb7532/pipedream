...
/*
  string cmd = "nvprof --profile-child-processes -o resnet50_2_4_theory_hybrid_";
  cmd += stm0.str();
...
*/
  ...
  cmd += " --node_rank ";
  cmd += stm0.str();
  cmd += " --nproc_per_node 4 main_with_runtime.py -s --distributed_backend gloo -m models.resnet50.gpus=2_4_theory --epochs 6 -b 32 --config_path models/resnet50/gpus=2_4_theory/hybrid_conf.json  --num_ranks_in_server 4 --master_addr ";
  cmd += (string)argv[1];
