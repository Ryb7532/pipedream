...
class Stage5(torch.nn.Module):
    def __init__(self):
        ...
        self.layer11 = torch.nn.Conv2d(2048, 512, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layer17 = torch.nn.Conv2d(512, 2048, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layer18 = torch.nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layer20 = torch.nn.ReLU(inplace=True)
        self.layer21 = torch.nn.Conv2d(2048, 512, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layer24 = torch.nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
        ...
        self.layer27 = torch.nn.Conv2d(512, 2048, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layer31 = torch.nn.AvgPool2d(kernel_size=7, stride=1, padding=0)
        self.layer34 = torch.nn.Linear(in_features=2048, out_features=1000, bias=True)
