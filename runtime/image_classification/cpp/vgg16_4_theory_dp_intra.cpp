...
/*
  string cmd = "nvprof --profile-child-processes -o vgg16_4_theory_dp_intra_";
  cmd += stm0.str();
...
*/
  ...
  cmd += " --node_rank ";
  cmd += stm0.str();
  cmd += " --nproc_per_node 4 main_with_runtime.py -s --distributed_backend nccl -m models.vgg16.gpus=4_theory --epochs 6 -b 4 --config_path models/vgg16/gpus=4_theory/dp_conf.json --no_input_pipelining --num_ranks_in_server 4 --master_addr ";
  cmd += (string)argv[1];
