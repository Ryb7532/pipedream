...
/*
  string cmd = "nvprof --profile-child-processes -o vgg16__4_theory_hybrid_";
  cmd += stm0.str();
...
*/
  ...
  cmd += " --node_rank ";
  cmd += stm0.str();
  cmd += " --nproc_per_node 4 main_with_runtime.py -s --distributed_backend gloo -m models.vgg16.gpus=_4_theory --epochs 6 -b 16 --config_path models/vgg16/gpus=_4_theory/hybrid_conf.json  --num_ranks_in_server 4 --master_addr ";
  cmd += (string)argv[1];
