...
/*
  string cmd = "nvprof --profile-child-processes -o resnet50_1_hybrid_";
  cmd += stm0.str();
...
*/
  ...
  cmd += " --node_rank ";
  cmd += stm0.str();
  cmd += " --nproc_per_node 1 main_with_runtime.py -s --distributed_backend gloo -m models.resnet50.gpus=1 --epochs 6 -b 32 --config_path models/resnet50/gpus=1/hybrid_conf.json  --num_ranks_in_server 1 --master_addr ";
  cmd += (string)argv[1];
