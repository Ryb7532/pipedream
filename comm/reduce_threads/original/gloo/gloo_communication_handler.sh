...
python gloo_communication_handler.py --master_addr localhost --rank 0 --broadcast &
python gloo_communication_handler.py --master_addr localhost --rank 1 --broadcast
