...
python point_to_point.py --backend gloo --master_addr localhost --rank 0 & #--broadcast &
python point_to_point.py --backend gloo --master_addr localhost --rank 1 #--broadcast
