...
class Stage1(torch.nn.Module):
    def __init__(self):
        ...
        self.layer10 = torch.nn.Linear(in_features=25088, out_features=4096, bias=True)
        self.layer11 = torch.nn.ReLU(inplace=True)
        self.layer12 = torch.nn.Dropout(p=0.5)
        self.layer13 = torch.nn.Linear(in_features=4096, out_features=4096, bias=True)
        self.layer14 = torch.nn.ReLU(inplace=True)
        self.layer15 = torch.nn.Dropout(p=0.5)
        self.layer16 = torch.nn.Linear(in_features=4096, out_features=1000, bias=True)
