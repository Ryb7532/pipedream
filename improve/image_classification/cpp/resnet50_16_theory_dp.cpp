...
/*
  string cmd = "nvprof --profile-child-processes -o resnet50_16_theory_dp_";
  cmd += stm0.str();
...
*/
  ...
  cmd += " --node_rank ";
  cmd += stm0.str();
  cmd += " --nproc_per_node 4 main_with_runtime.py -s --distributed_backend nccl -m models.resnet50.gpus=16_theory --epochs 6 -b 32 --config_path models/resnet50/gpus=16_theory/dp_conf.json --no_input_pipelining --num_ranks_in_server 4 --master_addr ";
  cmd += (string)argv[1];
